...
public class CourseIntegrationTests {
    ...
    private final String MODIFIED_NAME = "name1";
    ...
    public void testModifyCourseByValidId(){
        // setup
        CourseRequestDto request = new CourseRequestDto(MODIFIED_NAME, MODIFIED_DESCRIPTION, MODIFIED_COST_PER_SESSION);
        String url = "/courses/" + this.validId;
        ...
        assertNotNull(course);
        assertEquals(MODIFIED_NAME, course.getName());
    ...
    public void testModifyCourseWithInvalidCostPerSession(){
        // setup
        CourseRequestDto request = new CourseRequestDto(MODIFIED_NAME, MODIFIED_DESCRIPTION, INVALID_COST_PER_SESSION);
        String url = "/courses/" + this.validId;
