...
public class BillingInformation {
  ...
  public BillingInformation(String aAddress, String aPostalCode, String aCountry, String aName, String aCardNumber,
      int aCvc, Date aExpirationDate, CustomerAccount aCustomerAccount) {
    address = aAddress;
  ...
  public boolean equals(Object obj) {
    ...
    return this.getAddress() == other.getAddress()
        ...
        && this.getCardNumber() == other.getCardNumber()
        && this.getCvc() == other.getCvc()
